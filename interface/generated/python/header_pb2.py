...
_HEADER = _descriptor.Descriptor(
  name='Header',
  full_name='atlas.augmented.Header',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='frame_id', full_name='atlas.augmented.Header.frame_id', index=0,
...
Header = _reflection.GeneratedProtocolMessageType('Header', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:atlas.augmented.Header)
  ))
